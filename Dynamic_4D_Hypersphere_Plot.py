...
# Function to generate custom colors based on the W coordinate and color variation
def get_custom_color(w, color_variation):
    if color_variation == "Rainbow":
        ...
        r = 1.0
        g = (1 + np.sin(np.pi * w)) / 2
        b = 0.0
    elif color_variation == "Ice":
        r = 0.0
        g = (1 + np.cos(np.pi * w)) / 2
        b = 1.0
    else:
...
#--------------------------------------------------------------------------------------------------------------------------------------
#-----------------------------------------------------Use function for color variation-------------------------------------------------
