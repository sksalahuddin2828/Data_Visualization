...
def visualize_vectors(vectors, values, percentage_80=None):
    ...
    fig.update_layout(scene=dict(
        xaxis=dict(backgroundcolor="rgb(230, 230, 230)", gridcolor="rgb(255, 255, 255)", showbackground=True),
        yaxis=dict(backgroundcolor="rgb(230, 230, 230)", gridcolor="rgb(255, 255, 255)", showbackground=True),
        zaxis=dict(backgroundcolor="rgb(230, 230, 230)", gridcolor="rgb(255, 255, 255)", showbackground=True),
    ))

    # Update marker colorscale for visual appeal
    fig.update_traces(marker=dict(colorscale='Inferno', opacity=0.8))
