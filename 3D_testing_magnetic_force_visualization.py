...
# Add a creative 3D annotation with a diamond marker
...
# Add color transitions to the animation
colors = [f'rgb({int(255 * t)}, {int(255 * (1 - t))}, 0)' for t in t_values]

for i, frame in enumerate(animation_frames):
    frame.line.color = colors[i]
