...
fig_combined.update_layout(scene=dict(xaxis_title='x', yaxis_title='y', zaxis_title='z'), title='Visualization of f(x) and g(x) in 3D', scene_camera=dict(eye=dict(x=1.6, y=-1.6, z=0.8)))
