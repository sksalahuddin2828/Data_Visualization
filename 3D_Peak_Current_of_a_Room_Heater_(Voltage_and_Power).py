...
data = {'Voltage': voltage_grid.flatten(),
        'Power': power_grid.flatten(),
        'Current': current_grid.flatten()}
df = pd.DataFrame(data)

# Create an interactive 3D plot using Plotly
fig = px.scatter_3d(df, x='Voltage', y='Power', z='Current',
                    title='Peak Current of a Room Heater',
...
fig_matplotlib = plt.figure(figsize=(10, 6))
